...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : NetworkBehaviour
    {
        ...
        public Vector3 PreviousShootingDirection { get; set; }
        ...
        private void Update()
        {
            ...
            if (!m_Jump)
            {
                m_Jump = CrossPlatformInputManager.GetButtonDown("Jump") && canJump;
            }
        ...
        private void GetInput(out float speed)
        {
            ...
            m_IsWalking = !Input.GetKey(CustomInputManager.Instance.Input.RunningKeyCode) || IsCrouch;
#endif
            ...
            IsWalking = m_CharacterController.velocity.sqrMagnitude > 0 && !IsRunning;
        }
        ...
        private bool CheckIsSameDirection()
        {
            Ray ray = FirstPersonCamera.ViewportPointToRay(new Vector3(0.5f, 0.5f, 0f));
            float dotProduct = Vector3.Dot(ray.direction, PreviousShootingDirection);
            print(dotProduct);
        ...
        public void SetRotatateXSensitivity(float xSentitivity)
        {
            m_MouseLook.XSensitivity = xSentitivity;

        }
        public void SetRotateYSensitivity(float ySensitivity)
        {
            m_MouseLook.YSensitivity = ySensitivity;
        }
