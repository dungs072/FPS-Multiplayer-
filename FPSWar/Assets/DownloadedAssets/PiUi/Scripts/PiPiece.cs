...
public class PiPiece : MonoBehaviour
{
    ...
    private UnityEvent<int> OnCustomClick;
    private UnityEvent<string> OnCustomHoveEnter;
    ...
    public void SetData(PiUI.PiData piData, float iR, float oR, PiUI creator)
    {
        ...
        OnCustomClick = piData.OnCustomClick;
        OnCustomHoveEnter = piData.OnCustomHoverEnter;
        index = piData.Index;
        nameItem = piData.NameItem;
    ...
    {
        onHoverEnter.Invoke( );
        OnCustomHoveEnter?.Invoke(nameItem);
    }
